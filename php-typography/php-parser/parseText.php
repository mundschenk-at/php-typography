...
class parseText {
	...
	function load($rawText) {
		...
		// decimal		48-57 65-90 97-122 192-214,216-246,248-255
		// hex			31-39 41-5a 61-7a  c0-d6   d8-f6   f8-ff
		$htmlLetters = '
			(?:
				(?:												# alpha matches
					&
				...
				(?:												# decimal matches
					&\#
					(?: 4[89]|5[0-7]|9[7-9]|1[01][0-9]|12[0-2]|19[2-9]|20[0-9]|21[0-46-9]|2[23][0-9]|24[0-68-9]|25[0-5] )
					;
				)
				|
				(?:												# hexidecimal matches
				...
				(?:												# actual characters
					...
					\x{00f8}|\x{00f9}|\x{00fa}|\x{00fb}|\x{00fc}|\x{00fd}|\x{00fe}|\x{00ff}
				)
			)
		'; // required modifiers: x (multiline pattern) i (case insensitive) u (utf8)
